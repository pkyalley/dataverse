...
│
├── data/
│   └── employment--unemployment--and-labor-force-data.xlsx
│
├── labor-market-analysis.rmd     # Narrative HTML report (R Markdown)
├── report-style.css              # Custom CSS styling for the report
...
Open `labor-market-analysis.rmd` in RStudio and click **Knit**, or run:

```r
rmarkdown::render("labor-market-analysis.rmd", output_file = "labor-market-analysis.html")
```
