...
│
├── data/
│   └── guides-currently-licensed-in-new-york-state-20250127.csv
│
├── who-guides-new-york.rmd     # Narrative HTML report (R Markdown)
├── report-style.css         # Custom CSS for the HTML report
│
├── who-guides-new-york-app.r                    # Shiny dashboard application
│
└── readme.md
```
...
Open `who-guides-new-york.rmd` in RStudio and click **Knit**, or run from the console:

```r
rmarkdown::render("who-guides-new-york.rmd", output_file = "who-guides-new-york.html")
```

This will generate `who-guides-new-york.html` — open it in any browser.

### 3. Launch the Shiny Dashboard

Open `who-guides-new-york-app.r` in RStudio and click **Run App**, or from the console:
