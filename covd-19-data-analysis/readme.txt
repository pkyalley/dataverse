...
To run "dashboard.py"
Open a terminal in any code editor (Example: VS Code or PyCharm).
Navigate to the directory where the dashboard.py file is located. For example: cd d:\mystuff\aaa\covd-19-data-analysis
Run the following command: streamlit run dashboard.py
